...
describe('Testes relativos a função summationOf', () => {
  test('Verificar se summationOf é uma função', () => {
  ...
  it('summationOf(3)` retorna 6: soma de 1 até 3 = 1 + 2 + 3 = 6', () => {
  ...
  it('summationOf(10)` retorna 55: soma de 1 até 5 = 1 + 2 + 3 + 4 + 5 = 55', () => {
    expect(summationOf(10)).toBe(55);
  });

  it(`summationOf('') retorna erro`, () => {
    expect(() => summationOf('3')).toThrow('Essa função só aceita números como parametro');
  });
});